...
<#
.SYNOPSIS
    ARM template validation of Microsoft.Network/virtualNetworks resources
.EXAMPLE
    Invoke-Pester 
.NOTES
...
$resource = $templateData.resources | Where-Object {$_.type -eq "Microsoft.Network/virtualNetworks"} | Select-Object

Describe "Microsoft.Network/virtualNetworks" -Tags Unit {
